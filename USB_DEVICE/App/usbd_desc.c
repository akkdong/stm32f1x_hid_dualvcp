...
#define USBD_MANUFACTURER_STRING      "A" /* Add your manufacturer string */
#define USBD_PRODUCT_HS_STRING        "B" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "C" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING  "D" /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING      "E" /* Add your Interface High Speed string */
#define USBD_CONFIGURATION_FS_STRING  "F" /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING      "G" /* Add your Interface Full Speed string */
